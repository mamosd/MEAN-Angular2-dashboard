...
var SubmittedComponent = (function () {
    function SubmittedComponent(router, http) {
        this.router = router;
        this.http = http;
    ...
    SubmittedComponent.prototype.getServiceTemplates = function () {
        var _this = this;
        this.http.get('api/servicetemplates/')
            .map(function (res) { return res.json(); })
            .subscribe(function (servicetemplates) { _this.servicetemplates = servicetemplates; });
    };
    SubmittedComponent.prototype.st_selected = function (selected_st) {
        var _this = this;
    ...
    SubmittedComponent.prototype.updateFilter = function (event, key) {
